...
NOTAWESOMENESS = [
    'lame', 'horrible', 'terrible', 'awful', 'mediocre', 'subpar',
    'disappointing', 'dreadful', 'miserable', 'pathetic', 'sad',
    'unimpressive', 'underwhelming', 'worthless']
...
def diss():
    ...
    <html>
      ...
      <body>
        Huh, {player}! I think you're {insult}!
      </body>
    </html>
    """
